$(document).ready(async function () {
  ...
  async function getUser(id) {
    const response = await fetch(`https://mzm04u-3000.preview.csb.app:443/api/users/${id}`, {
      method: 'GET',
      headers: {
  ...
  async function getRooms() {
    const response = await fetch('https://mzm04u-3000.preview.csb.app:443/api/rooms', {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
        Accept: 'application/json',
  ...
  async function getRoom(id) {
    const response = await fetch(`https://mzm04u-3000.preview.csb.app:443/api/rooms/${id}`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
        Accept: 'application/json',
  ...
  async function updateRoom(room) {
    const response = await fetch(
      `https://mzm04u-3000.preview.csb.app:443/api/rooms/${room._id}`,
      {
        method: 'PATCH',
        headers: {
          'Content-Type': 'application/json',
  ...
  async function createRoom(name) {
    const room = {
      name,
      users: [],
      state: 'La partida aún no ha comenzado',
      game: null,
    };

    await fetch('https://mzm04u-3000.preview.csb.app:443/api/rooms', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Accept: 'application/json',
  ...
  async function createGame(room) {
    ...
    const response = await fetch('https://mzm04u-3000.preview.csb.app:443/api/games', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Accept: 'application/json',
  ...
  async function updateGame(room) {
    ...
    const response = await fetch(
      `https://mzm04u-3000.preview.csb.app:443/api/games/${room.game}`,
      {
        method: 'PATCH',
        headers: {
          'Content-Type': 'application/json',
