$(document).ready(async function () {
  ...
  async function getRoom(id) {
    const response = await fetch(`https://bdnhm2-3000.preview.csb.app:443/api/rooms/${id}`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
        Accept: 'application/json',
  ...
  async function createRoom(name) {
    ...
    await fetch('https://bdnhm2-3000.preview.csb.app:443/api/rooms', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Accept: 'application/json',
  ...
  async function createGame(room) {
    ...
    const response = await fetch('https://bdnhm2-3000.preview.csb.app:443/api/games', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Accept: 'application/json',
  ...
  async function updateGame(room) {
    ...
    const response = await fetch(
      `https://bdnhm2-3000.preview.csb.app:443/api/games/${room.game}`,
      {
        method: 'PATCH',
        headers: {
          'Content-Type': 'application/json',
