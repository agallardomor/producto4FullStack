$(document).ready(async function () {
  ...
  async function getUser(id) {
    const response = await fetch(`https://q2mldu-3000.preview.csb.app/api/users/${id}`, {
      method: 'GET',
      headers: {
  ...
  async function getRooms() {
    const response = await fetch('https://q2mldu-3000.preview.csb.app/api/rooms', {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
        Accept: 'application/json',
  ...
  async function getRoom(id) {
    const response = await fetch(`https://q2mldu-3000.preview.csb.app/api/rooms/${id}`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
        Accept: 'application/json',
  ...
  async function updateRoom(room) {
    const response = await fetch(
      `https://q2mldu-3000.preview.csb.app/api/rooms/${room._id}`,
      {
        method: 'PATCH',
        headers: {
          'Content-Type': 'application/json',
  ...
  async function createRoom(name) {
    ...
    await fetch('https://q2mldu-3000.preview.csb.app/api/rooms', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Accept: 'application/json',
  ...
  async function createGame(room) {
    ...
    const response = await fetch('https://q2mldu-3000.preview.csb.app/api/games', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Accept: 'application/json',
  ...
  async function updateGame(room) {
    ...
    const response = await fetch(
      `https://q2mldu-3000.preview.csb.app/api/games/${room.game}`,
      {
        method: 'PATCH',
        headers: {
          'Content-Type': 'application/json',
